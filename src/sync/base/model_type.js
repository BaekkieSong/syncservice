...
const ModelType = {
  ...
  BOOKMARKS: 2,
  // Declared 2nd, for debugger prettiness.
...
const FIRST_USER_MODEL_TYPE = ModelType.BOOKMARKS;
...
for (const i in ModelType) {
  if (
    ModelType[i] >= ModelType.UNSPECIFIED &&
    ModelType[i] <= LAST_REAL_MODEL_TYPE
  ) {
    fullModelTypeSet[i] = ModelType[i]; //.push(ModelType[i]);
  }
  if (
    ModelType[i] >= FIRST_REAL_MODEL_TYPE &&
    ModelType[i] <= LAST_REAL_MODEL_TYPE
  ) {
    /*주의!! 클라이언트에서 modelTypeSet(== EnumSet<modelType, Bookmarks,
    Experiments>)의 EnumBitSet값인 enums_는 인덱스로 조정되어 들어감.
    modelTypeSet은 'BOOKMARKS'(2)부터시작.
    REAL모델타입 범위에 따라 Min: 2, Max: 42로 표시되지만,
    enums_의 값은 Min값에 따라 조정(i - Min)되어 0부터 시작함.
    즉, enums_의 bitset의 값은 -2씩되어 표시되게 됨.
    (enums_=std::bitset={[39]=1, [40]=1}은 각각 NIGORI, EXPERIMENTS를 의미)
...
const ModelTypeInfoMap = [
  ...
  [
    ...
    "bookmarks",
    "Bookmarks",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.BOOKMARK,
    2,
  ],
  [
    ...
    "preferences",
    "Preferences",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.PREFERENCE,
    3,
  ],
  [
    ModelType.PASSWORDS,
    ...
    "passwords",
    "Passwords",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.PASSWORD,
    4,
  ],
  [
    ModelType.AUTOFILL_PROFILE,
    "AUTOFILL_PROFILE",
    "autofill_profiles",
    "Autofill Profiles",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.AUTOFILL_PROFILE,
    5,
  ],
  [
    ModelType.AUTOFILL,
    ...
    "autofill",
    "Autofill",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.AUTOFILL,
    6,
  ],
  [
    ModelType.AUTOFILL_WALLET_DATA,
    "AUTOFILL_WALLET",
    "autofill_wallet",
    "Autofill Wallet",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.AUTOFILL_WALLET,
    34,
  ],
  [
    ModelType.AUTOFILL_WALLET_METADATA,
    "WALLET_METADATA",
    "autofill_wallet_metadata",
    "Autofill Wallet Metadata",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.WALLET_METADATA,
    35,
  ],
  [
    ModelType.THEMES,
    ...
    "themes",
    "Themes",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.THEME,
    7,
  ],
  [
    ...
    "typed_urls",
    "Typed URLs",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.TYPED_URL,
    8,
  ],
  [
    ModelType.EXTENSIONS,
    "EXTENSION",
    "extensions",
    "Extensions",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.EXTENSION,
    9,
  ],
  [
    ModelType.SEARCH_ENGINES,
    "SEARCH_ENGINE",
    "search_engines",
    "Search Engines",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.SEARCH_ENGINE,
    10,
  ],
  [
    ModelType.SESSIONS,
    ...
    "sessions",
    "Sessions",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.SESSION,
    11,
  ],
  [
    ModelType.APPS,
    ...
    "apps",
    "Apps",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.APP,
    12,
  ],
  [
    ...
    "app_settings",
    "App settings",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.APP_SETTING,
    13,
  ],
  [
    ModelType.EXTENSION_SETTINGS,
    "EXTENSION_SETTING",
    "extension_settings",
    "Extension settings",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.EXTENSION_SETTING,
    14,
  ],
  [
    ModelType.APP_NOTIFICATIONS,
    "APP_NOTIFICATION",
    "app_notifications",
    "App Notifications",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.APP_NOTIFICATION,
    15,
  ],
  [
    ...
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.HISTORY_DELETE_DIRECTIVE,
    16,
  ],
  [
    ModelType.SYNCED_NOTIFICATIONS,
    "SYNCED_NOTIFICATION",
    "synced_notifications",
    "Synced Notifications",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.SYNCED_NOTIFICATION,
    20,
  ],
  [
    ModelType.SYNCED_NOTIFICATION_APP_INFO,
  ...
  [
    ...
    "dictionary",
    "Dictionary",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.DICTIONARY,
    22,
  ],
  [
    ModelType.FAVICON_IMAGES,
    "FAVICON_IMAGE",
    "favicon_images",
    "Favicon Images",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.FAVICON_IMAGE,
    23,
  ],
  [
    ModelType.FAVICON_TRACKING,
    "FAVICON_TRACKING",
    "favicon_tracking",
    "Favicon Tracking",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.FAVICON_TRACKING,
    24,
  ],
  [
    ModelType.DEVICE_INFO,
    "DEVICE_INFO",
    "device_info",
    "Device Info",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.DEVICE_INFO,
    18,
  ],
  [
    ModelType.PRIORITY_PREFERENCES,
    "PRIORITY_PREFERENCE",
    "priority_preferences",
    "Priority Preferences",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.PRIORITY_PREFERENCE,
    21,
  ],
  [
    ModelType.SUPERVISED_USER_SETTINGS,
    "MANAGED_USER_SETTING",
    "managed_user_settings",
    "Managed User Settings",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.MANAGED_USER_SETTING,
    26,
  ],
  [
    ModelType.DEPRECATED_SUPERVISED_USERS,
    "MANAGED_USER",
    "managed_users",
    "Managed Users",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.MANAGED_USER,
    27,
  ],
  [
    ModelType.DEPRECATED_SUPERVISED_USER_SHARED_SETTINGS,
  ...
  [
    ModelType.DEPRECATED_ARTICLES,
    "ARTICLE",
    "deprecated_articles",
    "Deprecated Articles",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.ARTICLE,
    28,
  ],
  [
    ModelType.APP_LIST,
    ...
    "app_list",
    "App List",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.APP_LIST,
    29,
  ],
  [
    ModelType.DEPRECATED_WIFI_CREDENTIALS,
    "WIFI_CREDENTIAL",
    "wifi_credentials",
    "WiFi Credentials",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.WIFI_CREDENTIAL,
    32,
  ],
  [
    ModelType.SUPERVISED_USER_WHITELISTS,
    "MANAGED_USER_WHITELIST",
    "managed_user_whitelists",
    "Managed User Whitelists",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.MANAGED_USER_WHITELIST,
    33,
  ],
  [
    ModelType.ARC_PACKAGE,
    "ARC_PACKAGE",
    "arc_package",
    "Arc Package",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.ARC_PACKAGE,
    36,
  ],
  [
    ModelType.PRINTERS,
    ...
    "printers",
    "Printers",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.PRINTER,
    37,
  ],
  [
    ...
    "reading_list",
    "Reading List",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.READING_LIST,
    38,
  ],
  [
    ModelType.USER_EVENTS,
    "USER_EVENT",
    "user_events",
    "User Events",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.USER_EVENT,
    39,
  ],
  [
    ModelType.MOUNTAIN_SHARES,
    "MOUNTAIN_SHARE",
    "mountain_shares",
    "Mountain Shares",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.MOUNTAIN_SHARE,
    40,
  ],
  [
    ModelType.USER_CONSENTS,
    "USER_CONSENT",
    "user_consent",
    "User Consents",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.USER_CONSENT,
    41,
  ],
  [
    ModelType.SEND_TAB_TO_SELF,
    "SEND_TAB_TO_SELF",
    "send_tab_to_self",
    "Send Tab To Self",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.SEND_TAB_TO_SELF,
    42,
  ],
  // ---- Proxy types ----
  ...
  [
    ...
    "nigori",
    "Encryption Keys",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.NIGORI,
    17,
  ],
  [
    ModelType.EXPERIMENTS,
    "EXPERIMENTS",
    "experiments",
    "Experiments",
    proto.sync_pb.EntitySpecifics.SpecificsVariantCase.EXPERIMENTS,
    19,
  ],
];
...
for (let i in ModelTypeInfoMap) {
  kModelTypeInfoMap.set(
    ModelTypeInfoMap[i][0],
    new ModelTypeInfo(ModelTypeInfoMap[i])
  );
  if (
    i > 0 &&
    SpecificsFieldName[getModelTypeNameFromModelType(ModelTypeInfoMap[i][0])]
  ) {
    kModelTypeInfoMap
      .get(ModelTypeInfoMap[i][0])
      .setSpecificsFieldName(
        SpecificsFieldName[
          getModelTypeNameFromModelType(ModelTypeInfoMap[i][0])
        ]
      );
    assert(
      kModelTypeInfoMap.get(ModelTypeInfoMap[i][0]).getSpecificsFieldName() ==
        SpecificsFieldName[
          getModelTypeNameFromModelType(ModelTypeInfoMap[i][0])
        ]
    );
...
assert(
  kModelTypeInfoMap.size == ModelType.MODEL_TYPE_COUNT,
  "kModelTypeInfoMap should have MODEL_TYPE_COUNT elements"
);
assert(
  43 == ModelType.MODEL_TYPE_COUNT,
...
// input type: ModelType, sync_pb::EntitySpecifics
function addDefaultFieldValue(modelType, pbEntitySpecifics) {
  ...
  switch (modelType) {
    ...
    case ModelType.MODEL_TYPE_COUNT:
      console.error(
        "\x1b[31m%s\x1b[0m",
        "Warning: No default field value for ",
        getModelTypeNameFromModelType(modelType)
      );
      break;
    ...
    case ModelType.AUTOFILL_PROFILE:
      pbEntitySpecifics.setAutofillProfile(
        new proto.sync_pb.AutofillProfileSpecifics()
      );
      break;
    ...
    case ModelType.AUTOFILL_WALLET_DATA:
      pbEntitySpecifics.setAutofillWallet(
        new proto.sync_pb.AutofillWalletSpecifics()
      );
      break;
    case ModelType.AUTOFILL_WALLET_METADATA:
      pbEntitySpecifics.setWalletMetadata(
        new proto.sync_pb.WalletMetadataSpecifics()
      );
      break;
    ...
    case ModelType.SEARCH_ENGINES:
      pbEntitySpecifics.setSearchEngine(
        new proto.sync_pb.SearchEngineSpecifics()
      );
      break;
    ...
    case ModelType.EXTENSION_SETTINGS:
      pbEntitySpecifics.setExtensionSetting(
        new proto.sync_pb.ExtensionSpecifics()
      );
      break;
    ...
    case ModelType.HISTORY_DELETE_DIRECTIVES:
      pbEntitySpecifics.setHistoryDeleteDirective(
        new proto.sync_pb.HistoryDeleteDirectiveSpecifics()
      );
      break;
    case ModelType.SYNCED_NOTIFICATIONS:
      pbEntitySpecifics.setSyncedNotification(
        new proto.sync_pb.SyncedNotificationSpecifics()
      );
      break;
    case ModelType.SYNCED_NOTIFICATION_APP_INFO:
      pbEntitySpecifics.setSyncedNotificationAppInfo(
        new proto.sync_pb.SyncedNotificationAppInfoSpecifics()
      );
      break;
    ...
    case ModelType.FAVICON_IMAGES:
      pbEntitySpecifics.setFaviconImage(
        new proto.sync_pb.FaviconImageSpecifics()
      );
      break;
    case ModelType.FAVICON_TRACKING:
      pbEntitySpecifics.setFaviconTracking(
        new proto.sync_pb.FaviconTrackingSpecifics()
      );
      break;
    ...
    case ModelType.PRIORITY_PREFERENCES:
      pbEntitySpecifics.setPriorityPreference(
        new proto.sync_pb.PriorityPreferenceSpecifics()
      );
      break;
    case ModelType.SUPERVISED_USER_SETTINGS:
      pbEntitySpecifics.setManagedUserSetting(
        new proto.sync_pb.ManagedUserSettingSpecifics()
      );
      break;
    case ModelType.DEPRECATED_SUPERVISED_USERS:
      pbEntitySpecifics.setManagedUser(
        new proto.sync_pb.ManagedUserSpecifics()
      );
      break;
    case ModelType.DEPRECATED_SUPERVISED_USER_SHARED_SETTINGS:
      pbEntitySpecifics.setManagedUserSharedSetting(
        new proto.sync_pb.ManagedUserSharedSettingSpecifics()
      );
      break;
    ...
    case ModelType.DEPRECATED_WIFI_CREDENTIALS:
      pbEntitySpecifics.setWifiCredential(
        new proto.sync_pb.WifiCredentialSpecifics()
      );
      break;
    case ModelType.SUPERVISED_USER_WHITELISTS:
      pbEntitySpecifics.setManagedUserWhitelist(
        new proto.sync_pb.ManagedUserWhitelistSpecifics()
      );
      break;
    ...
    case ModelType.READING_LIST:
      pbEntitySpecifics.setReadingList(
        new proto.sync_pb.ReadingListSpecifics()
      );
      break;
    ...
    case ModelType.MOUNTAIN_SHARES:
      pbEntitySpecifics.setMountainShare(
        new proto.sync_pb.MountainShareSpecifics()
      );
      break;
    case ModelType.USER_CONSENTS:
      pbEntitySpecifics.setUserConsent(
        new proto.sync_pb.UserConsentSpecifics()
      );
      break;
    case ModelType.SEND_TAB_TO_SELF:
      pbEntitySpecifics.setSendTabToSelf(
        new proto.sync_pb.SendTabToSelfSpecifics()
      );
      break;
    ...
    case ModelType.EXPERIMENTS:
      pbEntitySpecifics.setExperiments(
        new proto.sync_pb.ExperimentsSpecifics()
      );
      break;
  }
}

function getModelType(pbSyncEntity) {
  // sync_pb::SyncEntity
  //assert(isRoot(pbSyncEntity));
  let specificsModelType = getModelTypeFromSpecifics(
    pbSyncEntity.getSpecifics()
  );
  if (specificsModelType != ModelType.UNSPECIFIED) {
    return specificsModelType;
  }
  if (
    pbSyncEntity.getServerDefinedUniqueTag() != undefined &&
    pbSyncEntity.hasFolder() &&
    pbSyncEntity.getFolder()
  ) {
    return ModelType.TOP_LEVEL_FOLDER;
  }
  console.error(
    "\x1b[31m%s\x1b[0m",
    "NOT REACHED: Unknown datatype in sync proto."
  );
  return ModelType.UNSPECIFIED;
}

// input type: sync_pb::EntitySpecifics
function getModelTypeFromSpecifics(pbEntitySpecifics) {
  assert(
    43 == ModelType.MODEL_TYPE_COUNT,
    "When adding new protocol types, the following type lookup",
    "logic must be updated."
  );
  if (pbEntitySpecifics.hasBookmark()) return ModelType.BOOKMARKS;
  if (pbEntitySpecifics.hasPreference()) return ModelType.PREFERENCES;
  if (pbEntitySpecifics.hasPassword()) return ModelType.PASSWORDS;
  if (pbEntitySpecifics.hasAutofillProfile()) return ModelType.AutofillProfile;
  if (pbEntitySpecifics.hasAutofill()) return ModelType.AUTOFILL;
  ...
  if (pbEntitySpecifics.hasTheme()) return ModelType.THEMES;
  if (pbEntitySpecifics.hasTypedUrl()) return ModelType.TYPED_URLS;
  if (pbEntitySpecifics.hasExtension$())
    // TODO: Generate 버그. 확인 필요
    return ModelType.EXTENSIONS;
  if (pbEntitySpecifics.hasSearchEngine()) return ModelType.SEARCH_ENGINES;
  if (pbEntitySpecifics.hasSession()) return ModelType.SESSIONS;
  if (pbEntitySpecifics.hasApp()) return ModelType.APPS;
  if (pbEntitySpecifics.hasAppSetting()) return ModelType.APP_SETTINGS;
  ...
  if (pbEntitySpecifics.hasDictionary()) return ModelType.DICTIONARY;
  if (pbEntitySpecifics.hasFaviconImage()) return ModelType.FAVICON_IMAGES;
  if (pbEntitySpecifics.hasFaviconTracking()) return ModelType.FAVICON_TRACKING;
  if (pbEntitySpecifics.hasDeviceInfo()) return ModelType.DEVICE_INFO;
  ...
  if (pbEntitySpecifics.hasArticle()) return ModelType.DEPRECATED_ARTICLES;
  if (pbEntitySpecifics.hasAppList()) return ModelType.APP_LIST;
  ...
  if (pbEntitySpecifics.hasArcPackage()) return ModelType.ARC_PACKAGE;
  if (pbEntitySpecifics.hasPrinter()) return ModelType.PRINTERS;
  if (pbEntitySpecifics.hasReadingList()) return ModelType.READING_LIST;
  if (pbEntitySpecifics.hasUserEvent()) return ModelType.USER_EVENTS;
  if (pbEntitySpecifics.hasMountainShare()) return ModelType.MOUNTAIN_SHARES;
  if (pbEntitySpecifics.hasUserConsent()) return ModelType.USER_CONSENTS;
  if (pbEntitySpecifics.hasNigori()) return ModelType.NIGORI;
  if (pbEntitySpecifics.hasExperiments()) return ModelType.EXPERIMENTS;
  if (pbEntitySpecifics.hasSendTabToSelf()) return ModelType.SEND_TAB_TO_SELF;
  return ModelType.UNSPECIFIED;
}

const kUserSelectableDataTypeNames = [
  "bookmarks",
  "preferences",
  "passwords",
  "autofill",
...
assert(kUserSelectableDataTypeNames.length == 10);

// 값이 하나만 있는 것을 보장하려면 new Set으로 감쌀 것...
const protocolTypes = new Set(
  Object.values(modelTypeSet).filter((it) => {
    if (it >= ModelType.BOOKMARKS && it <= ModelType.EXPERIMENTS) return it;
  })
);
assert(protocolTypes.size == 41);

const userTypes = new Set(
  Object.values(modelTypeSet).filter((it) => {
    if (it >= FIRST_USER_MODEL_TYPE && it <= LAST_USER_MODEL_TYPE) return it;
  })
);
assert(userTypes.size == 39);

const alwaysPreferredUserTypes = new Set([
  ModelType.DEVICE_INFO,
  ModelType.USER_CONSENTS,
]);
assert(alwaysPreferredUserTypes.size == 2);

const userSelectableTypes = new Set([
  ModelType.BOOKMARKS,
  ModelType.PREFERENCES,
  ModelType.PASSWORDS,
  ModelType.AUTOFILL,
...
assert(userSelectableTypes.size == 10);

const priorityUserTypes = new Set([
  ModelType.DEVICE_INFO,
  ModelType.PRIORITY_PREFERENCES,
]);
assert(priorityUserTypes.size == 2);

const proxyTypes = new Set(
  Object.values(modelTypeSet).filter((it) => {
    if (it >= FIRST_PROXY_TYPE && it <= LAST_PROXY_TYPE) return it;
  })
);
assert(proxyTypes.size == 1);

const controlTypes = new Set(
  Object.values(modelTypeSet).filter((it) => {
    if (it >= FIRST_CONTROL_MODEL_TYPE && it <= LAST_CONTROL_MODEL_TYPE)
      return it;
  })
);
assert(controlTypes.size == 2);

function isUserSelectableType(modelType) {
...
assert(coreTypes.size == 6);

const priorityCoreTypes = new Set([
  ModelType.NIGORI,
  ModelType.EXPERIMENTS,
  ModelType.SUPERVISED_USER_SETTINGS,
]);
assert(priorityCoreTypes.size == 3);

const commitOnlyTypes = new Set([
  ModelType.USER_EVENTS,
  ModelType.USER_CONSENTS,
]);
assert(commitOnlyTypes.size == 2);
...
function getModelTypeFromSpecificsFieldNumber(fieldNumber) {
  for (let modelType of protocolTypes) {
...
function toFullModelTypeSet(inTypeSet) {
  assert(inTypeSet);
  // modelTypeSet
  // Not Implemented
...
function modelTypeToString(modelType) {
  if (
    ...
    modelType < ModelType.MODEL_TYPE_COUNT
  ) {
...
function modelTypeToStableIdentifier(modelType) {
  assert(
    modelType >= ModelType.UNSPECIFIED && modelType < ModelType.MODEL_TYPE_COUNT
  );
...
function modelTypeSetFromString(modelTypeString) {
  // Not Implemented
  assert(modelTypeString);
  // return modelTypeSet
}

function modelTypeSetToValue(modelTypeSet) {
  // Not Implemented
  assert(modelTypeSet);
...
function modelTypeToRootTag(modelType) {
  ...
  console.error(
    "\x1b[31m%s\x1b[0m",
    "NOT REACHED: No known extension for model type:",
    modelType
  );
  return "Invalid";
}
...
/* Comment(BK, 2020-08-14): JS에서는 call-by-reference개념이 없어서
인자로 ref를 넘길 수 없음
따라서 C++과 다르게 리턴값으로 notificationType을 넘기도록 변경 */
// function realModelTypeToNotificationType(modelType, notificationType) {
// function notificationTypeToRealModelType(notificationType, modelType) {
function getRealModelTypeToNotificationType(modelType) {
  // ModelType, string
...
function isRealDataType(modelType) {
  return (
    modelType >= FIRST_REAL_MODEL_TYPE && modelType < ModelType.MODEL_TYPE_COUNT
  );
}
...
// readingList는 빌드 플래그 ENABLE_READING_LIST 있을 때만 동작
...
exports.modelTypeToStableIdentifier = modelTypeToStableIdentifier;
...
/* Only for tests */
exports.getModelTypeInfoMap = () => {
  return kModelTypeInfoMap;
};
